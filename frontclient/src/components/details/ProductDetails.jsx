        ...
        <>
           ...
           <Typography>{product.title.longTitle}</Typography>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/>Sign up for Flipkart Pay Later and get Flipkart Gift Card worth Rs.100* Know More</Typography>
                <Typography><StyledBadge />Bank Offer 10% Off on Bank of Baroda Mastercard debit card first time transaction, T&C applied</Typography>
            </SmallText>
